...
class SimpleRegression(object):
        ...
        try:
            ...
            if isinstance(layer, nn.Conv2d):
                ...
                for i in range(n_filters):
                    SimpleRegression._visualize_tensors(
                        axes[i, :],
                        weights[i],
    ...
    def make_normalizer(loader):
        total_samples, total_means, total_stds = SimpleRegression.loader_apply(loader,
                                                                               SimpleRegression.statistics_per_channel)
    ...
    def set_clip_grad_norm(self, max_norm, norm_type=2):
        self.clipping = lambda: nn.utils.clip_grad_norm_(self.model.parameters(), max_norm=max_norm,
                                                         norm_type=norm_type)
